        ...
        <html>
            ...
            <body>
                <table width="500" border="1" cellspacing="0" cellpadding="0">
                    ...
                    <xsl:for-each select="spectateur" >
                        <xsl:sort select="personne/@age" order="ascending" data-type="number"/>
                        <tr>
                            ...
                            <td><xsl:text> 000 +</xsl:text><xsl:value-of select="tel/@prefix" /> <xsl:value-of select="tel" /></td>
                        </tr>
                    </xsl:for-each>            
                </table>
            </body>
